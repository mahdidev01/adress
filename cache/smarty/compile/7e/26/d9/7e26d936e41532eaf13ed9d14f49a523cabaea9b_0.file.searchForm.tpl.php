...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_67c0a563bacea4_24299067',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '7e26d936e41532eaf13ed9d14f49a523cabaea9b' => 
    array (
      0 => 'C:\\laragon\\www\\youradress\\modules\\wkroomsearchblock\\views\\templates\\hook\\searchForm.tpl',
      1 => 1740596551,
      2 => 'file',
    ),
  ),
...
function content_67c0a563bacea4_24299067 (Smarty_Internal_Template $_smarty_tpl) {
...
<form method="POST" id="search_hotel_block_form">
    ...
    <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_159878470567c0a563b7d561_58901551', "search_form_fields_wrapper");
?>
...
class Block_131475422067c0a563b7d8f2_99083397 extends Smarty_Internal_Block
{
...
?>
                ...
                <?php if ((isset($_smarty_tpl->tpl_vars['location_enabled']->value)) && $_smarty_tpl->tpl_vars['location_enabled']->value) {?>
                    <div class="form-group grid-item area-4">
                        <div class="dropdown">
                            <input type="text" class="form-control header-rmsearch-input input-location" id="hotel_location"
                                name="hotel_location" autocomplete="off"
                                placeholder="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Hotel Location','mod'=>'wkroomsearchblock'),$_smarty_tpl ) );?>
"
...
" <?php }?>>
                            <input hidden="hidden" name="location_category_id" id="location_category_id"
                                <?php if ((isset($_smarty_tpl->tpl_vars['search_data']->value))) {?>value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['search_data']->value['location_category_id'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
"
                                <?php }?>>
...
class Block_175784314367c0a563b809f2_77887338 extends Smarty_Internal_Block
{
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>

                <?php if (count($_smarty_tpl->tpl_vars['hotels_info']->value) <= 1 && !$_smarty_tpl->tpl_vars['show_hotel_name']->value) {?>
                    <input type="hidden" id="max_order_date" name="max_order_date"
                        value="<?php if ((isset($_smarty_tpl->tpl_vars['hotels_info']->value[0]['max_order_date']))) {
echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['hotels_info']->value[0]['max_order_date'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');
                    ...
                    <input type="hidden" id="preparation_time" name="preparation_time"
                        value="<?php if ((isset($_smarty_tpl->tpl_vars['hotels_info']->value[0]['preparation_time']))) {
...
">
                    <input type="hidden" id="htl_name" class="form-control header-rmsearch-input"
                        value="<?php echo $_smarty_tpl->tpl_vars['hotels_info']->value[0]['hotel_name'];?>
" readonly>
                <?php } else { ?>
                    <div class="form-group grid-item area-5">
                        <input type="hidden" id="hotel_cat_id" name="hotel_cat_id"
                            <?php if ((isset($_smarty_tpl->tpl_vars['search_data']->value))) {?>value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['search_data']->value['htl_dtl']['id_category'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" <?php }?>>
                        <input type="hidden" id="id_hotel" name="id_hotel"
                            <?php if ((isset($_smarty_tpl->tpl_vars['search_data']->value))) {?>value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['search_data']->value['htl_dtl']['id'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" <?php }?>>
                        <input type="hidden" id="max_order_date" name="max_order_date"
                            value="<?php if ((isset($_smarty_tpl->tpl_vars['max_order_date']->value))) {
echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['max_order_date']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');
                        ...
                        <input type="hidden" id="preparation_time" name="preparation_time"
                            value="<?php if ((isset($_smarty_tpl->tpl_vars['preparation_time']->value))) {
echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['preparation_time']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');
                        ...
                        <div class="hotel-selector-wrap <?php if ((isset($_smarty_tpl->tpl_vars['language_is_rtl']->value)) && $_smarty_tpl->tpl_vars['language_is_rtl']->value) {?>rtl<?php }?>">
                            <select name="id_hotel" class="chosen header-rmsearch-input"
                                data-placeholder="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Select Hotel','mod'=>'wkroomsearchblock'),$_smarty_tpl ) );?>
" id="id_hotel_button">
                                <option value=""></option>
                                <?php
...
"
                                        <?php if ((isset($_smarty_tpl->tpl_vars['search_data']->value)) && $_smarty_tpl->tpl_vars['name_val']->value['id'] == $_smarty_tpl->tpl_vars['search_data']->value['htl_dtl']['id']) {?>selected<?php }?>>
...
class Block_160539126767c0a563b8d793_98963818 extends Smarty_Internal_Block
{
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
" <?php }?>>
                            <div class="form-control header-rmsearch-input input-date" autocomplete="off" id="daterange_value_from"
                                placeholder="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Check-in','mod'=>'wkroomsearchblock'),$_smarty_tpl ) );?>
">
...
" <?php }?>>
                            <div class="form-control header-rmsearch-input input-date" autocomplete="off" id="daterange_value_to"
                                placeholder="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Check-out','mod'=>'wkroomsearchblock'),$_smarty_tpl ) );?>
">
...
" <?php }?>>
                        <input type="hidden" id="check_out_time" name="check_out_time"
                            <?php if ((isset($_smarty_tpl->tpl_vars['search_data']->value))) {?>value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['search_data']->value['date_to'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" <?php }?>>
                        <div class="form-control header-rmsearch-input input-date" id="daterange_value" autocomplete="off"
                            placeholder="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Check-in - Check-out','mod'=>'wkroomsearchblock'),$_smarty_tpl ) );?>
" tabindex="-1">
                            <span><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Check-in','mod'=>'wkroomsearchblock'),$_smarty_tpl ) );?>
 &nbsp;<i class="icon icon-minus"></i>&nbsp;
                                <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Check-out','mod'=>'wkroomsearchblock'),$_smarty_tpl ) );?>
</span></div>
                    </div>
                <?php }?>
            <?php
...
class Block_14618313867c0a563b93816_97539191 extends Smarty_Internal_Block
{
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
                ...
                <?php if ((isset($_smarty_tpl->tpl_vars['is_occupancy_wise_search']->value)) && $_smarty_tpl->tpl_vars['is_occupancy_wise_search']->value) {?>
                    <div class="form-group grid-item area-4">
                        <div class="dropdown">
                            <button
                                class="form-control input-occupancy header-rmsearch-input <?php if ((isset($_smarty_tpl->tpl_vars['error']->value)) && $_smarty_tpl->tpl_vars['error']->value == 1) {?>error_border<?php }?>"
                                type="button" data-toggle="dropdown" id="guest_occupancy">
                                <span
                                    class="pull-left"><?php if (((isset($_smarty_tpl->tpl_vars['search_data']->value['occupancy_adults'])) && $_smarty_tpl->tpl_vars['search_data']->value['occupancy_adults'])) {
...
echo $_smarty_tpl->tpl_vars['search_data']->value['occupancy_children'];?>
                                            ...
                                            <?php } else { ?>
                                                <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Child','mod'=>'wkroomsearchblock'),$_smarty_tpl ) );?>
...
?>
                                                <div class="occupancy-room-block">
                                                    <div class="occupancy_info_head"><span
                                                            class="room_num_wrapper"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Room','mod'=>'wkroomsearchblock'),$_smarty_tpl ) );?>
 -
                                                        ...
                                                        </span><?php if (!(isset($_smarty_tpl->tpl_vars['__smarty_foreach_occupancyInfo']->value['first']) ? $_smarty_tpl->tpl_vars['__smarty_foreach_occupancyInfo']->value['first'] : null)) {?><a class="remove-room-link pull-right"
                                                            href="#"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Remove','mod'=>'wkroomsearchblock'),$_smarty_tpl ) );?>
</a><?php }?></div>
...
">
                                                        <div class="row">
                                                            <div class="form-group occupancy_count_block col-sm-5 col-xs-6">
                                                                ...
                                                                <div>
                                                                    <input type="hidden" class="num_occupancy num_adults room_occupancies"
                                                                        name="occupancy[<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
][adults]"
                                                                        value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['occupancy']->value['adults'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
">
                                                            ...
                                                            <div class="form-group occupancy_count_block col-sm-7 col-xs-6">
                                                                ...
                                                                <div class="clearfix">
                                                                    <input type="hidden" class="num_occupancy num_children room_occupancies"
                                                                        name="occupancy[<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
][children]"
                                                                        value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['occupancy']->value['children'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
">
                                                                    <div class="occupancy_count pull-left">
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group children_age_info_block col-sm-12"
                                                                <?php if ((isset($_smarty_tpl->tpl_vars['occupancy']->value['child_ages'])) && $_smarty_tpl->tpl_vars['occupancy']->value['child_ages']) {?>style="display:block;"
                                                                <?php }?>>
...
?>
                                                                            <div>
                                                                                <select class="guest_child_age room_occupancies"
                                                                                    name="occupancy[<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
][child_ages][]">
                                                                                    <option value="-1" <?php if ($_smarty_tpl->tpl_vars['childAge']->value == -1) {?>selected<?php }?>>
                                                                                        <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Select 1','mod'=>'wkroomsearchblock'),$_smarty_tpl ) );?>
</option>
                                                                                    <option value="0" <?php if ($_smarty_tpl->tpl_vars['childAge']->value == 0) {?>selected<?php }?>>
                                                                                        <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Under 1','mod'=>'wkroomsearchblock'),$_smarty_tpl ) );?>
</option>
                                                                                    <?php
...
"
                                                                                            <?php if ($_smarty_tpl->tpl_vars['childAge']->value == $_smarty_tpl->tpl_vars['age']->value) {?>selected<?php }?>>
                                                                                            <?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['age']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
</option>
                                                                                    <?php }
}
?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                        <?php } else { ?>
                                            <div class="occupancy-room-block">
                                                <div class="occupancy_info_head"><span
                                                        class="room_num_wrapper"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Room - 1','mod'=>'wkroomsearchblock'),$_smarty_tpl ) );?>
</span></div>
                                    ...
                                    <div class="occupancy_block_actions">
                                        <span id="add_new_occupancy">
                                            <a class="add_new_occupancy_btn" href="#"><i class="icon-plus"></i>
                                                <span><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Add Room','mod'=>'wkroomsearchblock'),$_smarty_tpl ) );?>
</span></a>
                                        </span>
                                        <span>
                                            <button
                                                class="submit_occupancy_btn btn btn-primary"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Done','mod'=>'wkroomsearchblock'),$_smarty_tpl ) );?>
</button>
                                        </span>
                                    </div>
                                </div>
...
class Block_157958402667c0a563babb72_51096571 extends Smarty_Internal_Block
{
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
class Block_159878470567c0a563b7d561_58901551 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'search_form_fields_wrapper' => 
  array (
    0 => 'Block_159878470567c0a563b7d561_58901551',
  ),
  'search_form_location' => 
  array (
    0 => 'Block_131475422067c0a563b7d8f2_99083397',
  ),
  'search_form_hotel' => 
  array (
    0 => 'Block_175784314367c0a563b809f2_77887338',
  ),
  'search_form_dates' => 
  array (
    0 => 'Block_160539126767c0a563b8d793_98963818',
  ),
  'search_form_occupancy' => 
  array (
    0 => 'Block_14618313867c0a563b93816_97539191',
  ),
  'search_form_submit' => 
  array (
    0 => 'Block_157958402667c0a563babb72_51096571',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
        ...
        <div class="grid" id="search_form_fields_wrapper">
            <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_131475422067c0a563b7d8f2_99083397', 'search_form_location', $this->tplIndex);
?>

            <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_175784314367c0a563b809f2_77887338', 'search_form_hotel', $this->tplIndex);
?>


            <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_160539126767c0a563b8d793_98963818', 'search_form_dates', $this->tplIndex);
?>


            <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_14618313867c0a563b93816_97539191', 'search_form_occupancy', $this->tplIndex);
?>

                <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_157958402667c0a563babb72_51096571', 'search_form_submit', $this->tplIndex);
?>
