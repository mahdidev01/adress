...
class ProductCore extends ObjectModel
{
    ...
    */
     ...
     */
    public function addProductAttribute($price, $weight, $unit_impact, $ecotax, $quantity, $id_images, $reference, $ean13, $default, $location = null, $upc = null, $minimal_quantity = 1, $id_supplier = null)
    {
    ...
    */
    public function updateProductAttribute($id_product_attribute, $wholesale_price, $price, $weight, $unit, $ecotax,
        $id_images, $reference, $ean13, $default, $minimal_quantity, $available_date, $id_supplier = null, $location = null, $upc = null)
    {
        Tools::displayAsDeprecated();
