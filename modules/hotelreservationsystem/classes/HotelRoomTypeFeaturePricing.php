...
class HotelRoomTypeFeaturePricing extends ObjectModel
{
     ...
     */
    public function getHotelRoomTypesRatesAndInventoryByDate($id_hotel, $date_from, $date_to, $id_product=0)
    {
    ...
    public static function getRoomTypeFeaturePricesPerDay(
        ...
        $numberOfDays = isset($numberOfDays) ? $numberOfDays : 0;
        if ($use_tax) {
            $pricePerDay = ($numberOfDays > 0) ? ($totalPrice / $numberOfDays) : 0;
