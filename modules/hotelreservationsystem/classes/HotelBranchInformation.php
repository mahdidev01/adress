...
class HotelBranchInformation extends ObjectModel
{
    ...
    public function addCategory($name, $group_ids, $parent_cat = false, $ishotel = false, $idHotel = false, $link_rewrite = false, $meta_title = false, $meta_description = false, $meta_keywords = false)
    {
        $context = Context::getContext();
        if (!$parent_cat) {
